...
const About = () => (
    <section className={`${styles.paddings} relative z-10`}>
        ...
        <motion.div variants={staggerContainer} initial="hidden" whileInView="show" viewport={{ once: false, amount: 0.25 }} className={`${styles.innerWidth} mx-auto ${styles.flexCenter} flex-col`}>
            ...
            <motion.p variants={fadeIn('up', 'tween', 0.2, 1)} className="mt-[8px] font-normal text-[20px] sm:text-[32px] text-center text-secondary-white">
            ...
            <motion.img variants={fadeIn('up', 'tween', 0.3, 1)} src="/arrow-down.svg" alt="arrow down icon" className="w-[18px] h-[28px] object-contain mt-[28px]">
